...
//    private var txtCounter: TextView? = null
    private val questions = QuestionGerman()
       ...
       // txtQuestion = textView.findViewById(R.id.txvQuestion)
        ...
        fun openDialog() {
            AlertDialog.Builder(this)
                ...
                .setCancelable(false)
                .setPositiveButton("Quit", { dialog, id-> this@PlayScreenGermanActivity.finish(); })
                .show()
        }
        ...
        nButtonChoice1.setOnClickListener(View1.OnClickListener {
            ...
            if (nButtonChoice1.getText() == nAnswer)
            {
                ...
                nScore += 1;
                updateScore(nScore);
                Toast.makeText(this@PlayScreenGermanActivity, "correct", Toast.LENGTH_SHORT).show()
                if (nQuestionNumber == questions.nQuestions.size){
                    var i = Intent(this@PlayScreenGermanActivity, ResultsActivity::class.java);
                    var bundle = Bundle();
            ...
            else
            {
                ...
                Toast.makeText(this@PlayScreenGermanActivity, "wrong", Toast.LENGTH_SHORT).show()
            }
        })
        ...
        override fun onNavigationItemSelected(item: MenuItem): Boolean {
            return when (item.itemId){
                ...
                R.id.navigation_home -> {
                    startActivity(Intent(this@PlayScreenGermanActivity, MainActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_aboutus ->{
                    startActivity(Intent(this@PlayScreenGermanActivity, AboutUsActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_playquiz->{
                    startActivity(Intent(this@PlayScreenGermanActivity, TranslationActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_contactus->{
                    startActivity(Intent(this@PlayScreenGermanActivity, ContactUsActivity::class.java))
                    finish()
                    true
                }
    ...
    override fun onBackPressed() {
        AlertDialog.Builder(this)
            ...
            .setCancelable(false)
            .setPositiveButton("Yes", { dialog, id-> super@PlayScreenGermanActivity.onBackPressed() })

...
//    private var txtCounter: TextView? = null
    private val questions = QuestionItalian()
       ...
       // txtQuestion = textView.findViewById(R.id.txvQuestion)
        ...
        fun openDialog() {
            AlertDialog.Builder(this)
                ...
                .setCancelable(false)
                .setPositiveButton("Quit", { dialog, id-> this@PlayScreenItalianActivity.finish(); })
                .show()
        }
        ...
        nButtonChoice1.setOnClickListener(View1.OnClickListener {
            ...
            if (nButtonChoice1.getText() == nAnswer)
            {
                ...
                nScore += 1;
                updateScore(nScore);
                Toast.makeText(this@PlayScreenItalianActivity, "correct", Toast.LENGTH_SHORT).show()
                if (nQuestionNumber == questions.nQuestions.size){
                    var i = Intent(this@PlayScreenItalianActivity, ResultsActivity::class.java);
                    var bundle = Bundle();
            ...
            else
            {
                ...
                Toast.makeText(this@PlayScreenItalianActivity, "wrong", Toast.LENGTH_SHORT).show()
            }
        })
        ...
        override fun onNavigationItemSelected(item: MenuItem): Boolean {
            return when (item.itemId){
                ...
                R.id.navigation_home -> {
                    startActivity(Intent(this@PlayScreenItalianActivity, MainActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_aboutus ->{
                    startActivity(Intent(this@PlayScreenItalianActivity, AboutUsActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_playquiz->{
                    startActivity(Intent(this@PlayScreenItalianActivity, TranslationActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_contactus->{
                    startActivity(Intent(this@PlayScreenItalianActivity, ContactUsActivity::class.java))
                    finish()
                    true
                }
    ...
    override fun onBackPressed() {
        AlertDialog.Builder(this)
            ...
            .setCancelable(false)
            .setPositiveButton("Yes", { dialog, id-> super@PlayScreenItalianActivity.onBackPressed() })

...
//    private var txtCounter: TextView? = null
        ...
        override fun onNavigationItemSelected(item: MenuItem): Boolean {
            return when (item.itemId){
                ...
                R.id.navigation_home -> {
                    startActivity(Intent(this@PlayScreenSpanishActivity, MainActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_aboutus ->{
                    startActivity(Intent(this@PlayScreenSpanishActivity, AboutUsActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_playquiz->{
                    startActivity(Intent(this@PlayScreenSpanishActivity, TranslationActivity::class.java))
                    finish()
                    true
                }
                /**
                ...
                R.id.navigation_contactus->{
                    startActivity(Intent(this@PlayScreenSpanishActivity, ContactUsActivity::class.java))
                    finish()
                    true
                }
    ...
    override fun onBackPressed() {
        AlertDialog.Builder(this)
            ...
            .setCancelable(false)
            .setPositiveButton("Yes", { dialog, id-> super@PlayScreenSpanishActivity.onBackPressed() })
